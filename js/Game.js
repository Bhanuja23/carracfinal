  ...
  displayranks(){
    ...
    for(var plr in allPlayers){
      if(allPlayers[plr].rank === 1){
        text("1st :  "+allPlayers[plr].name,displayWidth/4-350,displayHeight-670);
      }
      else if(allPlayers[plr].rank === 2){
        text("2nd :  "+allPlayers[plr].name,displayWidth/4-10,150);
      }
      else if(allPlayers[plr].rank === 3){
        text("3rd :  "+allPlayers[plr].name,-350,150);
      }
      else{
        text("Honourable Mention :  "+allPlayers[plr].name,30,displayHeight/2-150);
      }
    }
  }
}
